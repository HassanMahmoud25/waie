...
export function SearchResultRow({ item, kind }: { item: Series | Topic; kind: "series" | "topic" }) {
  ...
  return (
    <Link href={href} className="glass-panel flex items-center justify-between gap-4 px-5 py-4">
